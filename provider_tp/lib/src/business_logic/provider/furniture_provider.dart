...
class FurnitureProvider with ChangeNotifier {
  late FurnitureState _state;

  final Repository repository;

  // FurnitureProvider({required this.repository})
  //     : _state = FurnitureState.initial(
  //           repository.getFurnitureList as List<Furniture>);
  ...
  Future<void> loadFurniture() async {
    _state = FurnitureState.initial(await repository.getFurnitureList());
    notifyListeners();
  }
